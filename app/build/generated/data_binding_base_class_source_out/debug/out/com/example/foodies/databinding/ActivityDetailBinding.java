...
public final class ActivityDetailBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView editData;
  ...
  private ActivityDetailBinding(@NonNull LinearLayout rootView, @NonNull ImageView back,
      @NonNull CardView cardImage, @NonNull CardView cardImage2, @NonNull ImageView deleteData,
      @NonNull TextView detailCategory, @NonNull TextView detailDesc,
      @NonNull TextView detailIngredients, @NonNull TextView detailName,
      @NonNull TextView detailTime, @NonNull PlayerView detailVideo, @NonNull ImageView editData,
      @NonNull LinearLayout main, @NonNull ImageView shareData) {
  ...
  public static ActivityDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.deleteData;
      ImageView deleteData = ViewBindings.findChildViewById(rootView, id);
      if (deleteData == null) {
        break missingId;
      }
      ...
      id = R.id.editData;
      ImageView editData = ViewBindings.findChildViewById(rootView, id);
      if (editData == null) {
        break missingId;
      }
      ...
      return new ActivityDetailBinding((LinearLayout) rootView, back, cardImage, cardImage2,
          deleteData, detailCategory, detailDesc, detailIngredients, detailName, detailTime,
          detailVideo, editData, main, shareData);
    }
