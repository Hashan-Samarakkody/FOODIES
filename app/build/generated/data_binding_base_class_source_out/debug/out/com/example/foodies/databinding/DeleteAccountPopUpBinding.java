...
public final class DeleteAccountPopUpBinding implements ViewBinding {
  ...
  private DeleteAccountPopUpBinding(@NonNull CardView rootView, @NonNull Button buttonNo,
  ...
  public static DeleteAccountPopUpBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.delete_account_pop_up, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static DeleteAccountPopUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DeleteAccountPopUpBinding((CardView) rootView, buttonNo, buttonYes);
    }
